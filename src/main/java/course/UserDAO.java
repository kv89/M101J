...
public class UserDAO {
    ...
    public boolean addUser(String username, String password, String email) {
        ...
        Document userD = new Document("_id", username).append("password", passwordHash);
        ...
        if (email != null && !email.equals("")) {
        	...
        	userD.append("email", email);
        }

        try {
            // XXX WORK HERE - done
            // insert the document into the user collection here
        	usersCollection.insertOne(userD);
            return true;
    ...
    public Document validateLogin(String username, String password) {
        ...
        // assign the result to the user variable. - done
